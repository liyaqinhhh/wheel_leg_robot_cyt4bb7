...
void store_or_read_DATA(int way)
{
    if (way == WRITE) // 写入内存
    {
        ...
        flash_union_buffer[25].float_type = Target_Yaw;
...
void switch_unit()
{
    ...
    case 0:
        ...
        break;
    case 1:
        ips200_show_string(6, 35 * 8, "^");
        data_change = 10;
        break;
    case 2:
        ips200_show_string(12, 35 * 8, "^");
        data_change = 1;
        break;
    case 3:
        ips200_show_string(24, 35 * 8, "^");
        data_change = 0.1;
        break;
    case 4:
        ips200_show_string(30, 35 * 8, "^");
        data_change = 0.01;
        break;
    case 5:
        ips200_show_string(36, 35 * 8, "^");
        data_change = 0.001;
        break;
    case 6:
        ips200_show_string(42, 35 * 8, "^");
        data_change = 0.0001;
        break;
    case 7:
        ips200_show_string(48, 35 * 8, "^");
        data_change = 0.00001;
        break;
    default:
        break;
    ...
    if (menu_mode == 0) // menu_mode == 0,进入菜单
    {
        ...
        case 0: // 第一面，平衡相关
            ...
            if (key)
            {
                ...
                case 1: // 俯仰角
                    data_operate(&imu660ra.offset_angle.pitch);
                    break;
                case 2: // 翻滚角
                    data_operate(&imu660ra.offset_angle.roll);
                    break;
                case 3: // gyro前后平衡参数
                    data_operate(&erect_Gyro_Pitch[0]);
                    break;
                case 4:
                    data_operate(&erect_Gyro_Pitch[1]);
                    break;
                case 5:
                    data_operate(&erect_Gyro_Pitch[2]);
                    break;
                case 6:
                    data_operate(&erect_Gyro_Pitch[3]);
                    break;
                case 7: // angle前后平衡参数
                    data_operate(&erect_Angle_Pitch[0]);
                    break;
                case 8:
                    data_operate(&erect_Angle_Pitch[1]);
                    break;
                case 9:
                    data_operate(&erect_Angle_Pitch[2]);
                    break;
                case 10:
                    data_operate(&erect_Angle_Pitch[3]);
                    break;
                case 11: // speed前后平衡参数
                    data_operate_int(&Yao.Target_Speed);
                    break;
                case 12:
                    data_operate(&Yao.Target_height);
                    break;
                case 13:
                    data_operate_uint8(&Show_Flag);
                    break;
                default:
                    break;
                } // page1-cursor end
        ...
        case 1:    // 第二面，转向参数
            ...
            if (key)
            {
                ...
                case 1:
                    data_operate(&erect_Gyro_Yaw[0]);
                    break;
                case 2:
                    data_operate(&erect_Gyro_Yaw[1]);
                    break;
                case 3:
                    data_operate(&erect_Gyro_Yaw[2]);
                    break;
                case 4:
                    data_operate(&erect_Gyro_Yaw[3]);
                    break;
                case 5:
                    data_operate(&erect_Angle_Yaw[0]);
                    break;
                case 6:
                    data_operate(&erect_Angle_Yaw[1]);
                    break;
                case 7:
                    data_operate(&erect_Angle_Yaw[2]);
                    break;
                case 8:
                    data_operate(&erect_Angle_Yaw[3]);
                    break;
                case 9:
                    data_operate(&erect_Angle_Yaw_2[0]);
                    break;
                case 10:
                    data_operate(&erect_Angle_Yaw_2[1]);
                    break;
                case 11:
                    data_operate(&erect_Angle_Yaw_2[2]);
                    break;
                case 12:
                    data_operate(&erect_Angle_Yaw_2[3]);
                    break;
                case 13:
                    data_operate(&Target_Yaw);
                    break;
                case 14:
                    data_operate(&P_Value_L[0]);
                    break;
                case 15:
                    data_operate(&P_Value_L[1]);
                    break;
                case 16:
                    data_operate(&P_Value_L[2]);
                    break;
                case 17:
                    data_operate(&P_Value_L[3]);
                    break;
                case 18:
                    data_operate(&P_Value_L[4]);
                    break;
                case 19:
                    data_operate(&P_Value_L[5]);
                    break;
                case 20:
                    data_operate(&P_Value_L[6]);
                    break;
                default:
                    break;
                } // page2-cursor end
        ...
        case 2:    // 第三面,舵机
            ...
            if (key)
            {
                ...
                case 1: // 俯仰角
                    data_operate_uint32(&pwmLF);
                    break;
                case 2: // 翻滚角
                    data_operate_uint32(&pwmLB);
                    break;
                case 3: // gyro前后平衡参数
                    data_operate_uint32(&pwmRF);
                    break;
                case 4:
                    data_operate_uint32(&pwmRB);
                    break;
                case 5:
                    data_operate(&erect_Inc_X[0]);
                    break;
                case 6:
                    data_operate(&erect_Inc_X[1]);
                    break;
                case 7: // angle前后平衡参数
                    data_operate(&erect_Inc_X[2]);
                    break;
                case 8:
                    data_operate(&erect_Inc_Y[0]);
                    break;
                case 9:
                    data_operate(&erect_Inc_Y[1]);
                    break;
                case 10:
                    data_operate(&erect_Inc_Y[2]);
                    break;
                case 11: // angle前后平衡参数
                    data_operate(&erect_Inc_Roll[0]);
                    break;
                case 12:
                    data_operate(&erect_Inc_Roll[1]);
                    break;
                case 13:
                    data_operate(&erect_Inc_Roll[2]);
                    break;
                case 14:
                    data_operate(&erect_yawan[0]);
                    break;
                case 15:
                    data_operate(&erect_yawan[1]);
                    break;
                case 16:
                    data_operate(&erect_yawan[2]);
                    break;
                default:
                    break;
                } // page3-cursor end
        ...
        case 3:    // 第四面 图像参数
            ...
            if (key)
            {
                ...
                case 1:
                    data_operate_uint8(&Thres_Filiter_Flag_1);
                    break;
                case 2:
                    data_operate_uint8(&Jump_Control_Flag);
                    break;
                case 3:
                    data_operate_uint8(&Single_Control_Flag);
                    break;
                case 4:
                    data_operate_uint8(&Zebra_Flag);
                    break;
                case 5:
                    data_operate_uint8(&Ramp_Flag);
                    break;
                case 6:
                    data_operate_uint8(&Small_S_Flag);
                    break;
                case 7:
                    data_operate(&Stretch_Coefficient);
                    break;
                case 8:
                    data_operate_uint16(&Max_Speed);
                    break;
                case 9:
                    data_operate_uint16(&Min_Speed);
                    break;
                case 10:
                    data_operate_uint16(&Jump_speed);
                    break;
                case 11:
                    data_operate_uint16(&Single_speed_1);
                    break;
                case 12:
                    data_operate_uint16(&Single_speed_2);
                    break;
                case 13:
                    data_operate_uint16(&Cross_Speed);
                    break;
                case 14:
                    data_operate_uint16(&Cross_State_4_Speed);
                    break;
                case 15:
                    data_operate_uint16(&L_Circle_State_1_Speed);
                    break;
                case 16:
                    data_operate_uint16(&L_Circle_State_2_Speed);
                    break;
                case 17:
                    data_operate_uint16(&L_Circle_State_3_Speed);
                    break;
                case 18:
                    data_operate_uint16(&L_Circle_State_4_Speed);
                    break;
                case 19:
                    data_operate_uint16(&L_Circle_State_5_Speed);
                    break;
                case 20:
                    data_operate_uint16(&R_Circle_State_1_Speed);
                    break;
                case 21:
                    data_operate_uint16(&R_Circle_State_2_Speed);
                    break;
                case 22:
                    data_operate_uint16(&R_Circle_State_3_Speed);
                    break;
                case 23:
                    data_operate_uint16(&R_Circle_State_4_Speed);
                    break;
                case 24:
                    data_operate_uint16(&R_Circle_State_5_Speed);
                    break;
                case 25:
                    data_operate_uint16(&Small_S_Speed);
                    break;
                case 26:
                    data_operate_uint16(&Ramp_State_2_Speed);
                    break;
                case 27:
                    data_operate_uint8(&Error_Line);
                    break;
                case 28:
                    data_operate_uint16(&Image_Gain);
                    break;
                case 29:
                    data_operate_uint16(&Image_EpTime);
                    break;
                case 30:
                    data_operate_uint8(&Change_Control);
                    break;
                default:
                    break;
                } // page4-cursor end
        ...
        case 4: // 第五面 跳跃与单边桥
            ...
            if (key)
            {
                ...
                case 1:
                    data_operate_uint8(&jump_line);
                    break;
                case 2:
                    data_operate_uint8(&jump_line_slowdown);
                    break;
                case 3:
                    data_operate_uint8(&T1);
                    break;
                case 4:
                    data_operate_uint8(&T2);
                    break;
                case 5:
                    data_operate_uint8(&T3);
                    break;
                case 6:
                    data_operate_uint8(&Bypass_Line);
                    break;
                case 7:
                    data_operate(&yaw_bypass);
                    break;
                case 8:
                    data_operate_uint16(&Bypass_Count1);
                    break;
                case 9:
                    data_operate_uint16(&Bypass_Count2);
                    break;
                case 10:
                    data_operate_uint16(&Bypass_Count3);
                    break;
                case 11:
                    data_operate_uint8(&Single_jg_line);
                    break;
                case 12:
                    data_operate_uint16(&Image_count_Single_End);
                    break;
                case 13:
                    data_operate_uint16(&ramp_judge_dis);
                    break;
                case 14:
                    data_operate_uint16(&ramp_end_dis);
                    break;
                case 15:
                    data_operate_uint16(&ramp_up_delay);
                    break;
