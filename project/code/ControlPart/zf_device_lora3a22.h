...
#define LORA3A22_UART_TX_PIN           (UART2_TX_P10_1)      // 遥控器接收机的RX引脚 连接单片机的TX引脚
#define LORA3A22_UART_RX_PIN           (UART2_RX_P10_0)      // 遥控器接收机的TX引脚 连接单片机的RX引脚
...
// @brief  LoRa3A22 ?ユ?妯″??? ??锛??缃 涓插?骞舵敞????朵腑? 
