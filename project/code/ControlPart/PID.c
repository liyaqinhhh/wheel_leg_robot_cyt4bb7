...
float erect_Gyro_Pitch[4] = {0.95, 0, 0, 0};  //  17.522  ,  0  ,  11  ,  0       // �����Ǳ���: 1,0,0,0
float erect_Angle_Pitch[4] = {200, 0, 0}; //  17.49  ,  0  ,  9  ,  0        // �Ƕȱ���: 400,0,0,0
...
//  @note       ģ��Ϊ���泯��࣬�ʿ�ǰ��Ϊ���ȣ���Ϊ���ȣ�ע������alpha��beta��Ӧ�Ķ���Ƕ�
//----------------------------------------------------------------
=======
/************************************* 五连杆逆运动学逆解 *************************************/
/**
...
<<<<<<< HEAD
    ...
    if (Single_state == 1 && flag_Single_HighState == 0) // վ��
    {
        //        TCount_falg_4ms= 1;
...
<<<<<<< HEAD
    pid_info->iError = (1 - a) * pid_info->iError + a * pid_info->LastError; // ʹ�ò��θ���ƽ�����˳���Ƶ���ţ���ֹ�ٶ�ͻ��
=======
...
<<<<<<< HEAD
    ...
    // 2.��ͨ�˲�
    pid_info->iError = (1 - a) * pid_info->iError + a * pid_info->LastError; // ʹ�ò��θ���ƽ�����˳���Ƶ���ţ���ֹͻ��
    pid_info->SumError += pid_info->iError;
