 ...
 */
//-------------------------------------------------------------------------------------------------------------------
//  @brief      将一对 double 坐标写入 Flash 缓冲区
//  @param      data1   X 坐标 (double, 64位 IEEE 754)
//  @param      data2   Y 坐标 (double, 64位 IEEE 754)
//  @param      z       写入位置索引 (0~127, 对应 buffer [4z..4z+3])
//  @return     void
//-------------------------------------------------------------------------------------------------------------------
 ...
 */
//-------------------------------------------------------------------------------------------------------------------
//  @brief      从 Flash 缓冲区读取一个 double 坐标分量
//  @param      a       选择坐标轴: 0=X坐标, 1=Y坐标
//  @param      x       读取位置索引 (0~127, 对应 buffer [4x..4x+3])
//  @return     double  读取到的坐标值
//-------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------
//  @brief      航位推算: 根据速度和偏航角更新实时坐标
//  @param      speed   电机编码器速度 (有符号整数)
//  @param      time    时间间隔 (秒, 通常 0.016)
//  @param      yaw     当前偏航角 (度)
//  @return     void
//-------------------------------------------------------------------------------------------------------------------
 ...
 */
//-------------------------------------------------------------------------------------------------------------------
//  @brief      计算两点间的欧几里得距离和方位角
//  @param      x1      起点 X 坐标
//  @param      y1      起点 Y 坐标
//  @param      x2      终点 X 坐标
//  @param      y2      终点 Y 坐标
//  @return     void    结果写入全局变量 dis_ins (距离) 和 yaw_ins (方位角 0~360 度)
//-------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------
//  @brief      惯导主状态机: 根据 ins_mode 分发到录点/循迹/分段编辑/分段导航
//  @param      void
//  @return     void
//-------------------------------------------------------------------------------------------------------------------
